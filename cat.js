class Cat {
    constructor(game) {
        this.game = game;
        this.animator = new Animator(ASSET_MANAGER.getAsset("./cat.png"), 0, 0, 551, 244, 11, 0.12, true, true);
    ...
    draw(context) {
        this.animator.drawFrame(this.game.clockTick, context, this.x, this.y, 0.4);
